 ...
 * customizer.js
 *
 * Custom edits to Theme Customizer enhancements for a better user experience.
...
( function( $ ) {
  ...
  wp.customize( 'featured_image4_title', function( value ) {
    value.bind( function( to ) {
      $( '.slide4-header' ).text( to );
    } );
  } );
  wp.customize( 'featured_image5_title', function( value ) {
    value.bind( function( to ) {
      $( '.slide4-header' ).text( to );
    } );
  } );
  ...
  wp.customize( 'slide4_button1_text', function( value ) {
    value.bind( function( to ) {
                    console.log(value);
                    if( to == '' ) {
                        $( '.slide4_button1' ).hide();
      ...
      $( '.slide4_button1' ).text( to );
    } );
  } );
  wp.customize( 'slide4_button2_text', function( value ) {
    value.bind( function( to ) {
                    if( to == '' ) {
                        $( '.slide4_button2' ).hide();
                    }else{
  ...
  wp.customize( 'slide5_button1_text', function( value ) {
    value.bind( function( to ) {
                    console.log(value);
                    if( to == '' ) {
                        $( '.slide5_button1' ).hide();
  ...
  wp.customize( 'slide5_button2_text', function( value ) {
    value.bind( function( to ) {
                    if( to == '' ) {
                        $( '.slide5_button2' ).hide();
                    }else{
  ...
  wp.customize( 'header_font', function( value ) {
    value.bind( function( to ) {
                    ...
                    $('h1,h2,h3,h4,h5,h6,.slide2-header,.slide1-header,.slide3-header,.slide4-header,.athena-title, .widget-title,.entry-title, .product_title').css({
                        'font-family': to
                    });
  ...
  wp.customize( 'featured_image3' , function( value ) {
      ...
      value.bind( function( to ) {            
          $( '.cameraSlide_2 img' ).attr( 'src', to ); 
      });
      
  });
  
  wp.customize( 'featured_image4' , function( value ) {
      value.bind( function( to ) {
          $( '.cameraSlide_3 img' ).attr( 'src', to ); 
      });
  });

  wp.customize( 'featured_image5' , function( value ) {
      value.bind( function( to ) {
          $( '.cameraSlide_4 img' ).attr( 'src', to ); 
      });
  });
