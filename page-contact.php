...
<div id="primary" class="content-area">
    ...
    <?php if ($form == 'yes') { ?>
        ...
        <?php if(isset($emailSent) && $emailSent == true) { 
          ...
          ?>
              <div class="thanks">
                <p><?php _e('Thanks, we look forward to reading your message. We do our best to reply to messages promptly, though we ask for your patience as it can sometimes take a couple of days.', 'virtue');?></p>
              </div>
        <?php } else { ?>
